...
module SegmentAPI
  class Analytics
    describe Analytics do
      let(:analytics) { SegmentAPI::Analytics.new :write_key => WRITE_KEY, :stub => true }
      ...
      describe '#respond_to?' do
        it 'responds to all public instance methods of SegmentAPI::Analytics::Client' do
          expect(analytics).to respond_to(*SegmentAPI::Analytics::Client.public_instance_methods(false))
        end
      end

      describe '#method' do
        SegmentAPI::Analytics::Client.public_instance_methods(false).each do |public_method|
